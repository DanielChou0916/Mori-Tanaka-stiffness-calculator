function HillAux = HillAux_2(Gauss_points_weights, a, Stiffness, n_ele)
    ...
    HillAux = 1/(8*pi) * (1/2) * (2*pi-0) * (Result* Gauss_points_weights(n_ele,3));
    %Coefficient (1/2) * (2*pi-0) is for range scale integral
end